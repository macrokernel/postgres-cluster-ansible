...
Резервное копирование выполняется неперывно и автоматически на текущем ведущем узле кластера СУБД посредством сжатия файлов журналов транзакций WAL и загрузки их в хранилище данных S3 при помощи утилиты WAL-G. Кроме того, один раз в сутки ночью выполняется создание полной копии данных СУБД в хранилище данных S3 при помощи утилиты WAL-G. Резервное копирование и восстановление подробно описано в разделе **5 Резервное копирование и восстановление**.

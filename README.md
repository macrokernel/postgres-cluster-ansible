...
Журнал сообщений полного резервного копирования отправляется в системную службу протоколирования **syslog** с тегом **wal-g**. Пример записей журанала резервного копирования:
```shell
